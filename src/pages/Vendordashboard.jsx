...
const VendorDashboard = () => {
  ...
  const vendorData = {
    ...
    vendorId: localStorage.getItem("vendor_mobile") || "vendor123",
  };

  const [isModalOpen, setIsModalOpen] = useState(false);
  const [productDetails, setProductDetails] = useState({
    vendorId: JSON.parse(localStorage.getItem("vendor_id")),
    name: "",
    price: "",
    category: "",
    stock: "",
  ...
  const handleSubmitProduct = () => {
    ...
    if (name && price) {
      axios
        .post("https://gocart-gqbi.onrender.com/products", productDetails)
        .then((res) => {
          alert("Product added!");
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="text-center my-6">
        <button
          onClick={toggleModal}
          className="bg-green-600 text-white py-3 px-8 rounded-lg font-semibold text-lg hover:bg-green-700"
        >
